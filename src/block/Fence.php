...
class Fence extends Transparent implements HorizontalConnectable{
	...
	protected function recalculateCollisionBoxes() : array{
		...
		$connectWest = $this->isConnectedAt(Facing::WEST);
		$connectEast = $this->isConnectedAt(Facing::EAST);
		...
		$connectNorth = $this->isConnectedAt(Facing::NORTH);
		$connectSouth = $this->isConnectedAt(Facing::SOUTH);
